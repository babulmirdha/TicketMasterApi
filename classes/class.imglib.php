...
class imglib extends db_connect
{
    ...
    public function createProfileImage($imgFilename, $addon)
    {
        $result = array("error" => true);
        ...
        if ($result['error'] === false) {
            ...
            $response = $cdn->uploadProfileImg(TEMP_PATH.$imgOrigin);
    ...
    public function createEventImage($imgFilename, $addon)
    {
        $result = array("error" => true);
    ...
    public function createCoverImg($imgFilename, $addon)
    {
        $result = array("error" => true);
        ...
        if ($result['error'] === false) {
            ...
            $response = $cdn->uploadCoverImg(TEMP_PATH.$imgOrigin);
    ...
    public function createGalleryImg($imgFilename, $addon)
    {
        $result = array("error" => true);
        ...
        if ($result['error'] === false) {
            ...
            $response = $cdn->uploadGalleryImg(TEMP_PATH.$imgOrigin);
